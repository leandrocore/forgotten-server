# Forgotten Server - [![Build status](https://ci.appveyor.com/api/projects/status/ix57m5o33asrws2x?svg=true)](https://ci.appveyor.com/project/marcomoa/forgotten-server "Download builds for Windows")
